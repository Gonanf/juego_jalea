...
export const game_categories = sqliteTable(
  "game_categories",
  {
    game_id: text("game_id")
      .notNull()
...
export const puntuation = sqliteTable(
  "puntuation",
  {
    user_id: text("user_id")
      .notNull()
...
export const event_winners = sqliteTable(
  "event_winners",
  {
...
export const event_evaluators = sqliteTable("event_evaluators",{
      user_id: text("user_id")
      .notNull()
      .references(() => user.id, { onDelete: "cascade" }),
    event_id: text("event_id")
...
(event_evaluators) => [
    primaryKey({
      columns: [event_evaluators.event_id, event_evaluators.user_id],
    }),
  ],)

export const user_library = sqliteTable(
  "user_library",
  {
    user_id: text("user_id")
      .notNull()
  ...
  (user_library) => [
    primaryKey({
      columns: [user_library.game_id, user_library.user_id],
    }),
  ],
);
