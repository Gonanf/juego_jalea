        ...
        <div class="flex w-full gap-5" v-else>
            <div class="grow">
                ...
                <UiItemContent>
                    ...
                    <UiItemDescription>{{ session.data.user.name }}</UiItemDescription>
                </UiItemContent>
            </UiItem>
            ...
            <UiItem variant="outline">
                <UiItemContent>
                    ...
                    <UiItemDescription>{{ session.data.user.nickname?? 'Sin apodo' }}</UiItemDescription>
                </UiItemContent>
            </UiItem>
            ...
            <UiItem variant="outline">
                <UiItemContent>
                    ...
                    <UiItemDescription>{{ session.data.user.email }}</UiItemDescription>
                </UiItemContent>
            </UiItem>
            </div>

            <img :src="session.data.user.image!" alt="usuario" referrerPolicy="no-referrer" class="object-cover w-[15%] rounded-md shadow-lg">
        </div>
    </UiCardContent>
 </UiCard>
</template>
